...
theme.loadEditor = function ()
	...
	local editor = {
		...
		Folded =				{ fg = moonlight.disabled, moonlight.none, style = 'italic' },
		...
		QuickFixLine =			{ fg = moonlight.highlight, moonlight.white, style = 'reverse' },
		qfLineNr =				{ fg = moonlight.highlight, moonlight.white, style = 'reverse' },
		...
		CursorLine =			{ fg = moonlight.none, bg = moonlight.active },
